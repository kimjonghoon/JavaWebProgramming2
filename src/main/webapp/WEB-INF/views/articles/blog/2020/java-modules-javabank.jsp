...
<p>
이 글은 <a href="<c:url value="/jdbc/JavaBank"/>">자바 은행</a> 예제를 모듈화하는 과정을 다룬다.<br />
자바 은행 소스에 내려받는다.
</p>
...
<ul id="related-articles-ul">
	<li><a href="<c:url value="/jdbc/JavaBank"/>">JDBC 예제 - 자바 은행</a></li>
	<li><a href="<c:url value="/blog/2019/java-9-modules"/>">자바 9 모듈</a></li>
	<li><a href="<c:url value="/blog/2020/java-modules-javabank"/>">자바 은행 예제 모듈화</a></li>
</ul>
