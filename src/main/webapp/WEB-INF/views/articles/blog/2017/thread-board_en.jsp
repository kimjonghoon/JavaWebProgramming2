...
For more information, See the <a href="<%=request.getContextPath() %>/jsp/Thread-BBS">Bulletin board with replies</a>. 
</p>
...
<ul id="references">
  <li><a href="<%=request.getContextPath() %>/jsp/Thread-BBS">Bulletin board with replies</a></li>
