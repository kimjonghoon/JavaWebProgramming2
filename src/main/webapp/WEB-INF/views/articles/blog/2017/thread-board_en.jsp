...
For more information, See the <a href="<c:url value="/jsp/Thread-BBS"/>">Bulletin board with replies</a>. 
</p>
...
<ul id="references">
  <li><a href="<c:url value="/jsp/Thread-BBS"/>">Bulletin board with replies</a></li>
