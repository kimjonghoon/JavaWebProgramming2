...
<h1>Board program using Oracle hierarchical query</h1>

<p>
Source: <a href="https://github.com/kimjonghoon/hierarchicalboard">https://github.com/kimjonghoon/hierarchicalboard</a>
</p>
...
<ul id="references">
  <li><a href="<%=request.getContextPath() %>/jsp/Thread-BBS#board-using-oracle-hierarchical-query">Bulletin board using oracle hierarchical query</a></li>
