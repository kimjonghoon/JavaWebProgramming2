...
<p>
예제 소스 : <a href="https://github.com/kimjonghoon/threadboard">https://github.com/kimjonghoon/threadboard</a>
</p>

<p>
실습할 예제는 계층형 게시판은 답변을 달 수 있는 게시판이다.
(<a href="<%=request.getContextPath() %>/jsp/Thread-BBS">계층형 게시판</a> 참조) 
</p>

<p>
SCOTT 계정에 다음 테이블과 시퀀스, 테스트 레코드를 생성한다.
('계층형 게시판'의 테이블과 시퀀스 이름이 다르다.)
</p>
