<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<article>
<div class="last-modified">Last Modified 2017.9.2</div>
	
<h1>모델 1 게시판</h1>

<p>
예제 소스 : <a href="https://github.com/kimjonghoon/model1board">https://github.com/kimjonghoon/model1board</a><br />
(설명은 <a href="<%=request.getContextPath() %>/jsp/BBS-Model1">모델 1 게시판</a> 참조)
</p>
...
('<a href="<%=request.getContextPath() %>/jsp/BBS-Model1">모델 1 게시판</a>'의 테이블과 시퀀스 이름과 다르다.)
</p>
...
<p>
디렉터리로 이동하여 mvn jetty:run 을 실행한 후, http://localhost:8080을 방문한다.
</p>

<span id="refer">참고</span>
<ul id="references">
	<li><a href="<%=request.getContextPath() %>/jsp/BBS-Model1">모델 1 게시판</a></li>
