...
(설명은 <a href="<c:url value="/jsp/BBS-Model1"/>">모델 1 게시판</a> 참조)
</p>
...
('<a href="<c:url value="/jsp/BBS-Model1"/>">모델 1 게시판</a>'의 테이블과 시퀀스 이름과 다르다.)
</p>
...
<ul id="references">
	<li><a href="<c:url value="/jsp/BBS-Model1"/>">모델 1 게시판</a></li>
