...
<ul id="related-articles-ul">
	<li><a href="<c:url value="/blog/2019/restful-url"/>">1 RESTful URL</a></li>
	<li><a href="<c:url value="/blog/2019/how-to-make-epub-with-eclipse"/>">2 이클립스를 사용해 EPUB ebook 만들기</a></li>
</ul>
