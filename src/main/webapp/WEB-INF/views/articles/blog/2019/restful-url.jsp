...
목록:		GET /list?boardCd=chat&amp;page=1&amp;search=
내용보기:		GET /view?boardCd=chat&amp;page=1&amp;search=
새글양식:		GET /write?boardCd=chat&amp;page=1&amp;search=
새글:		POST /write?boardCd=chat&amp;page=1
수정양식:		GET /modify?boardCd=chat&amp;page=1&amp;search=
수정:		POST /modify?boardCd=chat&amp;page=1&amp;search=
삭제:		POST /del?boardCd=chat&amp;page=1&amp;search=
</pre>
...
<pre style="border: 2px dotted grey;padding: 0.3em;">
목록:		GET /chat?page=1&amp;search=
내용보기:		GET /chat/54?page=1&amp;search=
새글양식:		GET /chat/new?page=1&amp;search=
새글:		POST /chat?page=1
수정양식:		GET /chat/54/edit?page=1&amp;search=
수정:		PUT /chat/54?page=1&amp;search=
삭제:		DELETE /chat/54?page=1&amp;search=
</pre>
...
<p>
'/chat?page=1&amp;search='에서 'chat'은 게시판 코드다.<br />
페이지 번호도 URL에 포함해 '/chat/1?search=' 도 된다고 생각할 수 있다.<br />
하지만 페이지 번호를 URL에 포함하지 않아야 한다.<br />
이유는 다음 두 가지다.
</p>

<p>
첫째, '/chat/1?search=' 에서 1은, 
...
<p>
둘째, 검색어가 없다면 '/chat?page=1&amp;search=' 대신 '/chat?page=1'로 요청할 수 있다.<br />
seachWord는 선택적 파라미터다. 선택적 파라미터는 URL에 포함하지 않는다.<br />
page는 search에 따라 값이 바뀐다. 선택적 파라미터에 영향을 받는 파라미터도 URL에 포함하지 않는다.
</p>
...
@PathVariable String boardCd로 선언된 매개변수가 있다면, '/chat?page=1&amp;search=' 요청에서 'chat'은 boardCd 매개변수에 할당된다.
</p>

<h3>내용보기</h3>

<p>
'/chat/54?page=1&amp;search=' 에서 54는 게시글의 고유번호다.
</p>
...
<p>
'/chat/54?page=1&amp;search=' 요청이 오면, 'chat'은 매개변수 boardCd에 할당되고 54는 매개변수 articleNo에 할당된다.
</p>

<h3>새글양식</h3>

<p>
'/chat?page=1&amp;search=' 처럼 수정하면 RESTful URL이 된다.<br />
...
<p>
'/chat/54?page=1&amp;search='이 RESTful URL이다.<br />
...
<ul id="related-articles-ul">
	<li><a href="<%=request.getContextPath() %>/blog/2019/restful-url">1 RESTful URL</a></li>
	<li><a href="<%=request.getContextPath() %>/blog/2019/how-to-make-epub-with-eclipse">2 이클립스를 사용해 EPUB ebook 만들기</a></li>
</ul>
