...
<head>
<meta charset="UTF-8" />
<title><spring:message code="reflection.title"/></title>
<meta name="viewport" content="width=device-width, initial-scale=1"/>
<meta name="Keywords" content="<spring:message code="reflection.keys"/>"/>
<meta name="Description" content="<spring:message code="reflection.desc"/>"/>
...
<c:choose>
	<c:when test="${lang == 'ko'}">
		<jsp:include page="../../articles/blog/2019/reflection.jsp" />
	</c:when>
	<c:otherwise>
		<jsp:include page="../../articles/blog/2019/reflection_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
