...
<head>
<meta charset="UTF-8" />
<title><spring:message code="how-to-install-the-apache-on-ubuntu.title" /></title>
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta name="Keywords" content="<spring:message code="how-to-install-the-apache-on-ubuntu.keys" />" />
<meta name="Description" content="<spring:message code="how-to-install-the-apache-on-ubuntu.desc" />" />
...
<c:choose>
	<c:when test="${lang == 'ko'}">
		<jsp:include page="../../articles/blog/2019/how-to-install-the-apache-on-ubuntu.jsp" />
	</c:when>
	<c:otherwise>
		<jsp:include page="../../articles/blog/2019/how-to-install-the-apache-on-ubuntu_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
