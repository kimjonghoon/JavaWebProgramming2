...
<head>
<meta charset="UTF-8" />
<title><spring:message code="how-to-install-mariadb-on-ubuntu.title"/></title>
...
<c:choose>
	<c:when test="${lang == 'ko'}">
		<jsp:include page="../../articles/blog/2019/how-to-install-mariadb-on-ubuntu.jsp" />
	</c:when>
	<c:otherwise>
		<jsp:include page="../../articles/blog/2019/how-to-install-mariadb-on-ubuntu_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
