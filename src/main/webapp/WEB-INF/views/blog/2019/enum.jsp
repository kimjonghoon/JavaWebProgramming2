...
<head>
<meta charset="UTF-8" />
<title><spring:message code="enum.title"/></title>
<meta name="viewport" content="width=device-width, initial-scale=1"/>
<meta name="Keywords" content="<spring:message code="enum.keys"/>"/>
<meta name="Description" content="<spring:message code="enum.desc"/>"/>
...
<c:choose>
	<c:when test="${lang == 'ko'}">
		<jsp:include page="../../articles/blog/2019/enum.jsp" />
	</c:when>
	<c:otherwise>
		<jsp:include page="../../articles/blog/2019/enum_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
