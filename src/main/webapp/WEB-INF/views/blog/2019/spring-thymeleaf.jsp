...
<head>
<meta charset="UTF-8" />
<title><spring:message code="spring-thymeleaf.title" /></title>
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta name="Keywords" content="<spring:message code="spring-thymeleaf.keys" />" />
<meta name="Description" content="<spring:message code="spring-thymeleaf.desc" />" />
...
<c:choose>
	<c:when test="${lang == 'ko'}">
		<jsp:include page="../../articles/blog/2019/spring-thymeleaf.jsp" />
	</c:when>
	<c:otherwise>
		<jsp:include page="../../articles/blog/2019/spring-thymeleaf_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
