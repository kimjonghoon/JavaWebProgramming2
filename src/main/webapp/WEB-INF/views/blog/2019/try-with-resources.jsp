...
<head>
<meta charset="UTF-8" />
<title><spring:message code="try-with-resources.title"/></title>
<meta name="viewport" content="width=device-width, initial-scale=1"/>
<meta name="Keywords" content="<spring:message code="try-with-resources.keys"/>"/>
<meta name="Description" content="<spring:message code="try-with-resources.desc"/>"/>
...
<c:choose>
	<c:when test="${lang == 'ko'}">
		<jsp:include page="../../articles/blog/2019/try-with-resources.jsp" />
	</c:when>
	<c:otherwise>
		<jsp:include page="../../articles/blog/2019/try-with-resources_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
