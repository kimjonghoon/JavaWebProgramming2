...
<head>
<meta charset="UTF-8" />
<title><spring:message code="how-to-make-epub.title"/></title>
<meta name="viewport" content="width=device-width, initial-scale=1"/>
<meta name="Keywords" content="<spring:message code="how-to-make-epub.keys"/>"/>
<meta name="Description" content="<spring:message code="how-to-make-epub.desc"/>"/>
...
<c:choose>
	<c:when test="${lang == 'ko'}">
		<jsp:include page="../../articles/blog/2019/how-to-make-epub.jsp" />
	</c:when>
	<c:otherwise>
		<jsp:include page="../../articles/blog/2019/how-to-make-epub_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
