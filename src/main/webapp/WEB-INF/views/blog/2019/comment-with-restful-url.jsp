...
<head>
<meta charset="UTF-8" />
<title><spring:message code="comment-with-restful-url.title" /></title>
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta name="Keywords" content="<spring:message code="comment-with-restful-url.keys" />" />
<meta name="Description" content="<spring:message code="comment-with-restful-url.desc" />" />
...
<c:choose>
	<c:when test="${lang == 'ko'}">
		<jsp:include page="../../articles/blog/2019/comment-with-restful-url.jsp" />
	</c:when>
	<c:otherwise>
		<jsp:include page="../../articles/blog/2019/comment-with-restful-url_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
