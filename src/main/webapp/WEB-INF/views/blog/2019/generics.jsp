...
<head>
<meta charset="UTF-8" />
<title><spring:message code="generics.title"/></title>
<meta name="viewport" content="width=device-width, initial-scale=1"/>
<meta name="Keywords" content="<spring:message code="generics.keys"/>"/>
<meta name="Description" content="<spring:message code="generics.desc"/>"/>
...
<c:choose>
	<c:when test="${lang == 'ko'}">
		<jsp:include page="../../articles/blog/2019/generics.jsp" />
	</c:when>
	<c:otherwise>
		<jsp:include page="../../articles/blog/2019/generics_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
