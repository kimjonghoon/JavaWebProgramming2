...
<head>
<meta charset="UTF-8" />
<title><spring:message code="default-method.title" /></title>
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta name="Keywords" content="<spring:message code="default-method.keys" />" />
<meta name="Description" content="<spring:message code="default-method.desc" />" />
...
<c:choose>
	<c:when test="${lang == 'ko'}">
		<jsp:include page="../../articles/blog/2019/default-method.jsp" />
	</c:when>
	<c:otherwise>
		<jsp:include page="../../articles/blog/2019/default-method_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
