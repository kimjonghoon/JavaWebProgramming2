...
<head>
<meta charset="UTF-8" />
<title><spring:message code="static-import.title" /></title>
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta name="Keywords" content="<spring:message code="static-import.keys" />" />
<meta name="Description" content="<spring:message code="static-import.desc" />" />
...
<c:choose>
	<c:when test="${lang == 'ko'}">
		<jsp:include page="../../articles/blog/2019/static-import.jsp" />
	</c:when>
	<c:otherwise>
		<jsp:include page="../../articles/blog/2019/static-import_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
