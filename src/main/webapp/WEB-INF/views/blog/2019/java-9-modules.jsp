...
<head>
<meta charset="UTF-8" />
<title><spring:message code="java-9-modules.title"/></title>
<meta name="viewport" content="width=device-width, initial-scale=1"/>
<meta name="Keywords" content="<spring:message code="java-9-modules.keys"/>"/>
<meta name="Description" content="<spring:message code="java-9-modules.desc"/>"/>
...
<c:choose>
	<c:when test="${lang == 'ko'}">
		<jsp:include page="../../articles/blog/2019/java-9-modules.jsp" />
	</c:when>
	<c:otherwise>
		<jsp:include page="../../articles/blog/2019/java-9-modules_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
