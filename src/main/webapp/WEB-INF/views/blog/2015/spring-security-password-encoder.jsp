...
<head>
<meta charset="UTF-8" />
<title><spring:message code="spring-security-password-encoder.title" /></title>
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta name="Keywords" content="<spring:message code="spring-security-password-encoder.keys" />" />
<meta name="Description" content="<spring:message code="spring-security-password-encoder.desc" />" />
...
<c:choose>
	...
	<c:otherwise>
		<jsp:include page="../../articles/blog/2015/spring-security-password-encoder_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
