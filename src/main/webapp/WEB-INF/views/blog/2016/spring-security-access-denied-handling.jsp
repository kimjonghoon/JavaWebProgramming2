...
<head>
<meta charset="UTF-8" />
<title><spring:message code="spring-security-access-denied-handling.title" /></title>
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta name="Keywords" content="<spring:message code="spring-security-access-denied-handling.keys" />" />
<meta name="Description" content="<spring:message code="spring-security-access-denied-handling.desc" />" />
...
<c:choose>
	<c:when test="${lang == 'ko'}">
		<jsp:include page="../../articles/blog/2016/spring-security-access-denied-handling.jsp" />
	</c:when>
	<c:otherwise>
		<jsp:include page="../../articles/blog/2016/spring-security-access-denied-handling_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
