...
<head>
<meta charset="UTF-8" />
<title><spring:message code="model2mysqlboard-using-DBCP.title"/></title>
<meta name="viewport" content="width=device-width, initial-scale=1"/>
<meta name="Keywords" content="<spring:message code="model2mysqlboard-using-DBCP.keys"/>"/>
<meta name="Description" content="<spring:message code="model2mysqlboard-using-DBCP.desc"/>"/>
...
<c:choose>
	<c:when test="${lang == 'ko'}">
		<jsp:include page="../../articles/blog/2017/model2mysqlboard-using-DBCP.jsp" />
	</c:when>
	<c:otherwise>
		<jsp:include page="../../articles/blog/2017/model2mysqlboard-using-DBCP_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
