...
<head>
<meta charset="UTF-8" />
<title><spring:message code="Setting-development-environment-in-Ubuntu.title" /></title>
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta name="Keywords" content="<spring:message code="Setting-development-environment-in-Ubuntu.keys" />" />
<meta name="Description" content="<spring:message code="Setting-development-environment-in-Ubuntu.desc" />" />
...
<c:choose>
	<c:when test="${lang == 'ko'}">
		<jsp:include page="../../articles/blog/2017/Setting-development-environment-in-Ubuntu.jsp" />
	</c:when>
	<c:otherwise>
		<jsp:include page="../../articles/blog/2017/Setting-development-environment-in-Ubuntu_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
