...
<head>
<meta charset="UTF-8" />
<title><spring:message code="thread-board.title" /></title>
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta name="Keywords" content="<spring:message code="thread-board.keys" />" />
<meta name="Description" content="<spring:message code="thread-board.desc" />" />
...
<c:choose>
	<c:when test="${lang == 'ko'}">
		<jsp:include page="../../articles/blog/2017/thread-board.jsp" />
	</c:when>
	<c:otherwise>
		<jsp:include page="../../articles/blog/2017/thread-board_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
