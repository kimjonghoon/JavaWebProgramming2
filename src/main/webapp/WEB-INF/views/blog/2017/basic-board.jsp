...
<head>
<meta charset="UTF-8" />
<title><spring:message code="basic-board.title" /></title>
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta name="Keywords" content="<spring:message code="basic-board.keys" />" />
<meta name="Description" content="<spring:message code="basic-board.desc" />" />
...
<c:choose>
	<c:when test="${lang == 'ko'}">
		<jsp:include page="../../articles/blog/2017/basic-board.jsp" />
	</c:when>
	<c:otherwise>
		<jsp:include page="../../articles/blog/2017/basic-board_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
