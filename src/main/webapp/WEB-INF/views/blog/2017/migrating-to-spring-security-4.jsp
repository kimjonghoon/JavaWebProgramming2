...
<head>
<meta charset="UTF-8" />
<title><spring:message code="migrating-to-spring-security-4.title"/></title>
<meta name="viewport" content="width=device-width, initial-scale=1"/>
<meta name="Keywords" content="<spring:message code="migrating-to-spring-security-4.keys"/>"/>
<meta name="Description" content="<spring:message code="migrating-to-spring-security-4.desc"/>"/>
...
<c:choose>
	<c:when test="${lang == 'ko'}">
		<jsp:include page="../../articles/blog/2017/migrating-to-spring-security-4.jsp" />
	</c:when>
	<c:otherwise>
		<jsp:include page="../../articles/blog/2017/migrating-to-spring-security-4_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
