...
<head>
<meta charset="UTF-8" />
<title><spring:message code="downloadController.title"/></title>
<meta name="viewport" content="width=device-width, initial-scale=1"/>
<meta name="Keywords" content="<spring:message code="downloadController.keys"/>"/>
<meta name="Description" content="<spring:message code="downloadController.desc"/>"/>
...
<c:choose>
	<c:when test="${lang == 'ko'}">
		<jsp:include page="../../articles/blog/2017/downloadController.jsp" />
	</c:when>
	<c:otherwise>
		<jsp:include page="../../articles/blog/2017/downloadController_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
