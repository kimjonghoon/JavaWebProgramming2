...
<head>
<meta charset="UTF-8" />
<title><spring:message code="spring-mvc-ajax-example.title" /></title>
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta name="Keywords" content="<spring:message code="spring-mvc-ajax-example.keys" />" />
<meta name="Description" content="<spring:message code="spring-mvc-ajax-example.desc" />" />
...
<c:choose>
	<c:when test="${lang == 'ko'}">
		<jsp:include page="../../articles/blog/2017/spring-mvc-ajax-example.jsp" />
	</c:when>
	<c:otherwise>
		<jsp:include page="../../articles/blog/2017/spring-mvc-ajax-example_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
