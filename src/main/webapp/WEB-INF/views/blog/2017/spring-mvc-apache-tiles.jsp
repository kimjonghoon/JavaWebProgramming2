...
<head>
<meta charset="UTF-8" />
<title><spring:message code="spring-mvc-apache-tiles.title"/></title>
<meta name="viewport" content="width=device-width, initial-scale=1"/>
<meta name="Keywords" content="<spring:message code="spring-mvc-apache-tiles.keys"/>"/>
<meta name="Description" content="<spring:message code="spring-mvc-apache-tiles.desc"/>"/>
...
<c:choose>
	<c:when test="${lang == 'ko'}">
		<jsp:include page="../../articles/blog/2017/spring-mvc-apache-tiles.jsp" />
	</c:when>
	<c:otherwise>
		<jsp:include page="../../articles/blog/2017/spring-mvc-apache-tiles_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
