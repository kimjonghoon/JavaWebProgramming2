...
<head>
<meta charset="UTF-8" />
<title><spring:message code="board-using-oracle-hierarchical-query.title"/></title>
<meta name="viewport" content="width=device-width, initial-scale=1"/>
<meta name="Keywords" content="<spring:message code="board-using-oracle-hierarchical-query.keys"/>"/>
<meta name="Description" content="<spring:message code="board-using-oracle-hierarchical-query.desc"/>"/>
...
<c:choose>
	<c:when test="${lang == 'ko'}">
		<jsp:include page="../../articles/blog/2017/board-using-oracle-hierarchical-query.jsp" />
	</c:when>
	<c:otherwise>
		<jsp:include page="../../articles/blog/2017/board-using-oracle-hierarchical-query_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
