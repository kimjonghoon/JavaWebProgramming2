...
<head>
<meta charset="UTF-8" />
<title><spring:message code="jetty-maven-plugin.title" /></title>
...
<c:choose>
	<c:when test="${lang == 'ko'}">
		<jsp:include page="../../articles/blog/2017/jetty-maven-plugin.jsp" />
	</c:when>
	<c:otherwise>
		<jsp:include page="../../articles/blog/2017/jetty-maven-plugin_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
