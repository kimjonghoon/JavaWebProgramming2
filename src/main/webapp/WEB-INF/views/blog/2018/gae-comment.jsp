...
<head>
<meta charset="UTF-8" />
<title><spring:message code="gae-comment.title"/></title>
<meta name="viewport" content="width=device-width, initial-scale=1"/>
<meta name="Keywords" content="<spring:message code="gae-comment.keys"/>"/>
<meta name="Description" content="<spring:message code="gae-comment.desc"/>"/>
...
<c:choose>
	<c:when test="${lang == 'ko'}">
		<jsp:include page="../../articles/blog/2018/gae-comment.jsp" />
	</c:when>
	<c:otherwise>
		<jsp:include page="../../articles/blog/2018/gae-comment_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
