...
<head>
<meta charset="UTF-8" />
<title><spring:message code="gaefile.title" /></title>
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta name="Keywords" content="<spring:message code="gaefile.keys" />" />
<meta name="Description" content="<spring:message code="gaefile.desc" />" />
...
<c:choose>
	<c:when test="${lang == 'ko'}">
		<jsp:include page="../../articles/blog/2018/gaefile.jsp" />
	</c:when>
	<c:otherwise>
		<jsp:include page="../../articles/blog/2018/gaefile_en.jsp" />
	</c:otherwise>
</c:choose>
<!-- content end -->
		</div>
