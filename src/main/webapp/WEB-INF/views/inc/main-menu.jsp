...
<ul id="nav">
    ...
    <li><a href="<c:url value="/jdbc/JDBC-Intro"/>">JDBC</a></li>
    ...
    <li><a href="<c:url value="/javascript/introduction"/>">JavaScript</a></li>
    <li><a href="<c:url value="/google-app-engine/building-gae-projects-with-maven"/>">Google Cloud</a></li>
    <li><a href="<c:url value="/blog"/>">Blog</a></li>
    <li><a href="<c:url value="/bbs/chat?page=1"/>">BBS</a></li>
</ul>